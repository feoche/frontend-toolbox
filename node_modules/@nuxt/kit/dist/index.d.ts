...
declare function addAutoImport(_autoImports: AutoImport | AutoImport[]): void;
 ...
 */
declare function findPath(paths: string[], opts?: ResolvePathOptions): Promise<string | null>;
/**
